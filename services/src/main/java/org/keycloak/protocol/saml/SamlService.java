...
public class SamlService extends AuthorizationEndpointBase {
    ...
    public abstract class BindingProtocol {
        ...
        protected Response loginRequest(String relayState, AuthnRequestType requestAbstractType, ClientModel client) {
            ...
            authSession.setClientNote(SamlProtocol.SAML_REQUEST_AUTHNCONTEXT, requestAbstractType.getRequestedAuthnContext().getAuthnContextClassRef().toArray(new String[0]));
